...
Unfortunately, my router's IP conflicts the default USB Armory IP becuase i use ethernet cable to connect to the internet. We can change its IP address by modifying the network configuration files directly through UART. 
...
This sub-section is about connection sharing between USB armory and host machine.
